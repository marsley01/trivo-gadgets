...
export async function POST(req: Request) {
  try {
    ...
    // Validate email format before storing or sending anything
          ...
          html: `
            <div style="font-family: sans-serif; background-color: #0a0a0a; color: #ffffff; padding: 40px 20px; text-align: center;">
              ...
              <p style="font-size: 16px; color: #cccccc; line-height: 1.5; max-width: 500px; margin: 0 auto;">
                You're in. We'll send you honest phone and laptop deals and buying guides from Trivo Kenya. No spam.
              </p>
    ...
    // Notify admin (non-critical — errors are silently ignored)
    try {
